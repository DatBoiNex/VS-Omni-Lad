...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			case 'volcano':
			{
						defaultCamZoom = 0.6;
						curStage = 'volcano';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('volcano/stageback'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.3, 0.3);
						bg.active = false;
						add(bg);

						var stageFront:FlxSprite = new FlxSprite(-650, 350).loadGraphic(Paths.image('volcano/stagefront'));
						...
						var stageCurtains:FlxSprite = new FlxSprite(-750, -300).loadGraphic(Paths.image('volcano/stagecurtains'));
	...
	*/
	...
	override function stepHit()
	{
		...
		if (SONG.song.toLowerCase() == 'volcano ass')
		{
			if (curStep == 68)
			{
				vibrate = true;
		...
		//jesus fucking christ can this shit just plz fuking work
